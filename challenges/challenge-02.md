...
|---|---|---|---|
| $G_A$: star $K_{1,3}$ | $\{(0,1), (0,2), (0,3)\}$ | 3 | center atom plus three atoms at 120° and radius $\rho$, with $\rho < R_b < \sqrt{3}\,\rho$ |
| $G_B$: cycle $C_5$ | $\{(0,1), (1,2), (2,3), (3,4), (4,0)\}$ | 2 | regular pentagon of side $s$, with $s < R_b < 1.618\,s$ (the diagonal) |
